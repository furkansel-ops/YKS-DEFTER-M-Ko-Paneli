...
test('panel yalnız sol menü ve boş çalışma alanı ile açılır',()=>{
  ...
  for(const label of ['Ana Sayfa','Öğrenciler','Programlar','Takip & Rapor','Deneme Analizi','Konular','Hata Defteri','Mesajlar','Ayarlar'])assert.ok(html.includes(label),label);
